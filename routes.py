...
def edit_sample(sample):
    ...
    return render_template('sample.html', page=path, sample=sample, formdata=form)
...
def publish_sample(sample):
    ...
    return render_template('sample.html',  page=path, sample=sample, formdata=request.form)
